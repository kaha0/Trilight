...
TrixiePony::TrixiePony(TextureStorage * ts)
{
	...
	MaxBoxes = 3;  // skills by se nemìly nastavovat v konstruktoru
	boxcost = 50.0f;
	levitatecost = 1.0f;
	canlevitate = true;
...
void TrixiePony::AddBox(MagicBox * mb)  // pouze pøidává box, pokud je jich moc, musí se pøedtím nìjakej box odstranit ruènì
{
